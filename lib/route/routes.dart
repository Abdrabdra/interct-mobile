...
import '../screens/podachaObyavlenie/homepodachaObyav.dart';
...
import '../screens/zapchasti/zapchastiSingleAdvPage.dart';
...
class AutolikeRouter {
  Route generateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case AppRoute.zapchastSingleAdv:
        return CupertinoPageRoute(
          builder: (context) => ZapchastSingleAdvPage(),
        );
      case AppRoute.avtoPage:
        return CupertinoPageRoute(
          builder: (context) => HomeAvtoPage(),
        );
      case AppRoute.zapchastiPage:
        return CupertinoPageRoute(
          builder: (context) => HomeZapchastiPage(),
        );
